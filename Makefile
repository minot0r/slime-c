...
main:
	...
	$(CC) $(CFLAGS) -o bin/$(NAME) $(SRC) obj/math/collider.o obj/other/linkedlist.o obj/game/player_state.o obj/game/slime.o obj/game/ball.o obj/game/key_manager.o obj/game/rect_collide.o obj/game/game.o `sdl2-config --cflags --libs` -lm
